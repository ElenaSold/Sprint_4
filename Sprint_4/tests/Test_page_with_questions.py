...
class TestQuestions:
    ...
    def test_show_answer_how_much(self):
    ...
    def test_show_answer_want_some_scooters(self):
        # перешли на страницу приложения
        self.driver.get('https://qa-scooter.praktikum-services.ru/')
    ...
    def test_show_answer_how_calculated(self):
        # перешли на страницу приложения
        self.driver.get('https://qa-scooter.praktikum-services.ru/')
        ...
        WebDriverWait(self.driver, 3).until(expected_conditions.element_to_be_clickable(TestLocatorsQuestions.q_how_calculated))
    ...
    def test_show_answer_can_i_order(self):
        # перешли на страницу приложения
        self.driver.get('https://qa-scooter.praktikum-services.ru/')
        ...
        WebDriverWait(self.driver, 3).until(expected_conditions.element_to_be_clickable(TestLocatorsQuestions.q_can_i_order))
    ...
    def test_show_answer_possible_to_prolong(self):
        # перешли на страницу приложения
        self.driver.get('https://qa-scooter.praktikum-services.ru/')
        ...
        WebDriverWait(self.driver, 3).until(expected_conditions.element_to_be_clickable(TestLocatorsQuestions.q_possible_to_prolong))
    ...
    def test_show_answer_do_u_bring_charger(self):
        # перешли на страницу приложения
        self.driver.get('https://qa-scooter.praktikum-services.ru/')
        ...
        WebDriverWait(self.driver, 3).until(expected_conditions.element_to_be_clickable(TestLocatorsQuestions.q_do_u_bring_charger))
    ...
    def test_show_answer_cancel_an_order(self):
        # перешли на страницу приложения
        self.driver.get('https://qa-scooter.praktikum-services.ru/')
        ...
        WebDriverWait(self.driver, 3).until(expected_conditions.element_to_be_clickable(TestLocatorsQuestions.q_cancel_an_order))
    ...
    def test_show_answer_bring_from_mcad(self):
        # перешли на страницу приложения
        self.driver.get('https://qa-scooter.praktikum-services.ru/')
        ...
        WebDriverWait(self.driver, 3).until(expected_conditions.element_to_be_clickable(TestLocatorsQuestions.q_bring_from_mcad))
